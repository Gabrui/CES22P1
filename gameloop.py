...
class PainelGameplay(Cena):
    ...
    def __init__(self, audio, entrada, renderizador, larguraTela, alturaTela,
        ...
        barra__vida__aviao_inimigo = Vida(100, Ponto(300, 100), Ponto(2, 2),
                                          "imgTeste/barra_vida_interna_IA.png",
                                          "imgTeste/barra_vida_externa_IA.png")
        projetil_arma_aviao_inimigo = Projetil("imgTeste/BulletEnemies.png",
                                               "imgTeste/MetalHit1.ogg", 100,
                                               Ponto(0, 0))
        arma_aviao_inimigo = Arma("imgTeste/MP5_SMG_auto.ogg",
                                  projetil_arma_aviao_inimigo)
        aviaoInimigo = AviaoInimigo("imgTeste/aviaoInimigo em x.png",
                                    "imgTeste/aviaoInimigo em -y.png",
                                    "imgTeste/airplane_b25-1.ogg",
                                    arma_aviao_inimigo,
                                    Ponto(300, 100),
                                    barra__vida__aviao_inimigo,
                                    "imgTeste/Explosion_6.ogg",
                                    "imgTeste/Shells_falls.ogg",
                                    None, None,
                                    None, None)
        arma_aviao_inimigo.setDono(aviaoInimigo)
        ...
        simulador.adicionaFilho(barra__vida__aviao_inimigo)
